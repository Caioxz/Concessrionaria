...
private JMenuItem itemContribuir;
		      ...
		      principal = new JMenuBar();
		        ...
		        viOrc.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
				        ...
				        double valorAr = 400;
						  ...
						  double valorTeslaS = 10000.0;
						  double valorTeslaX = 200000.0;
						  double valorCorollaSpo = 100000.0;
						  double valorCorollaGLI = 90000.0;
						  double valor = 0;
		        ...
		        delete.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						JOptionPane.showMessageDialog(null,"Informações deletados com sucesso!!","Atenção", JOptionPane.WARNING_MESSAGE);
		        ...
		        itemContribuir = new JMenuItem("Contribua");
		        itemDonate = new JMenuItem("Doar");
		       ...
		       ajuda.add(itemContribuir);
		       
		       ajuda.add(itemDonate);
